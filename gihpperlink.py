...
mode_label = tk.Label(root, text="Gihpperink by SIRT0AX", font=('Helvetica', 16, 'bold'))
configure_widget(mode_label)
mode_label.pack(pady=10)

website_label = tk.Label(root, text="Instagram: @sirtoax", font=('Helvetica', 10, 'italic'))
